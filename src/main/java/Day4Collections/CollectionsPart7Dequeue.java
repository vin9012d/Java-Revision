...
public class CollectionsPart7Dequeue {
  ...
  /*
      Queue vs Deque
      Queue → follows FIFO (First In First Out), insert at rear, remove from front
  Deque (Double Ended Queue) → allows insert & remove from both front and rear
  Queue is more restricted, Deque is more flexible/powerful
  Deque can act as both Queue + Stack
  Common impl: Queue → LinkedList, PriorityQueue; Deque → ArrayDeque, LinkedList
  Use Queue for simple processing order, Deque when you need two-way operations
       */
  ...
  public static void main(String[] args) {
    ...
    // when queue is empty
    //  String firstGet = adq.getFirst(); //Exception in thread "main"
