...
public class GenericsPart2 {
  ...
  public static <K, V> Pair1<K, V> createPair(K key, V value) {
    return new Pair1<>(
        key,
        value); // Java internally convert this to return new Pair1<String, Integer>(key, value);
    // it converts because of return type has generic Pair1<K, V>
  }
  ...
  public static void main(String[] args) {
    ...
    Pair1<String, String> pair2 = createPair("Two", "two");
    ...
    //  printNumber("dfdsfds"); //Required type:T Provided: String reason: no instance(s) of type
    // variable(s) exist so that String conforms to Number
